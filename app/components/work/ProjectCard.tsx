    ...
    >
      ...
      >
        <Image
          ...
          width={500}
          height={500}
          className={`absolute -bottom-2 hidden w-[70%] sm:w-[85%] md:w-[60%] lg:block lg:max-w-[55%] ${
            id % 2 === 0
              ? "right-0 rounded-tl-[30px]"
              : "left-0 rounded-tr-[30px]"
          }`}
          priority={true}
        />
        <div
          ...
          {available ? (
            <>
              ...
              <Link
                ...
                className=" w-[60px] rounded-full bg-white p-5 text-[20px] md:w-[25px] md:text-[24px] lg:w-[65px] lg:text-[28px]"
                data-blobity
                data-blobity-radius="35"
                data-blobity-offset-x="4"
                data-blobity-offset-y="4"
        ...
        <div
          className={`absolute text-white  ${
            !(id % 2 === 0)
              ? "right-0 top-24 mr-0 ml-10 md:right-0 md:ml-0 lg:right-0 lg:top-36  lg:mr-4"
              : "left-10 top-24 ml-0 md:mr-12 lg:top-36 lg:ml-4"
            ...
            {technologies.map((IconComponent, id) => (
              <div key={id} className={"relative"}>
                <Link
                  ...
                  className="w-[20px] text-[30px] md:w-[25px] md:text-[24px] lg:w-[30px] lg:text-[28px]"
                  title={techLinks[id]}
